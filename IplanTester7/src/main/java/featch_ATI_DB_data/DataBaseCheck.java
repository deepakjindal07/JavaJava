...
//	 }
	...
	public static List<String> DB_check(String Inumber) throws SQLException {
		...
		String com3 = "select ExternalId from Enterprise.tblSubaudit ts where SubauditId in (\n"
				...
				+ "(select GradPlanId from GraduationPlanner.tblGradPlan tgp where iNumber ="+Inumber+" and plantype =1))";

		//System.out.println("Database Value:");
		
		return DataBaseTesting.executeQuery(com3);
