...
public class p23 extends Applet implements ItemListener
	...
	public void itemStateChanged(ItemEvent ie)
	   {
	   if(c1.getState()==true && !c2.getState() && !c3.getState())
		{
		t1.setText("Checkbox 1 selected ");
		}
	   else if(!c1.getState() && c2.getState()==true && !c3.getState())
		{
		t1.setText("Checkbox 2 selected ");
		}
	   else	if(!c1.getState() && !c2.getState() && c3.getState()==true)
		{
		t1.setText("Checkbox 3 selected ");
		}
	   else if(!c1.getState() && !c2.getState() && !c3.getState())
		{
		t1.setText(" ");
		}
	   if(ra1.getState()==true && !ra2.getState() && !ra3.getState())
		{
		t2.setText("Rdiobutton 1 selected ");
		}
	   else if(!ra1.getState() && ra2.getState()==true && !ra3.getState())
		{
		t2.setText("Radiobutton 2 selected ");
		}
	   else if(!ra1.getState() && !ra2.getState() && ra3.getState()==true)
		{
