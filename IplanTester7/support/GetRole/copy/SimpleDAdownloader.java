...
public class SimpleDAdownloader {
	...
	public static void RachaelCheck1(String Inumber) throws IOException {
		...
		// Continue processing
		System.out.println("File " + Inumber + " does not exist. Continuing processing.");
		// Add your code here to process further if the file does not exist
